...
namespace OpenTabletDriver.Desktop.Binding
{
    ...
    public class PenScrollBinding : IStatePositionBinding
    {
        ...
        public string Direction
        {
            ...
            set
            {
                ...
                {
                    Log.Write(nameof(PenScrollBinding), $"Invalid scroll direction '{value}', defaulting to 'Both'", LogLevel.Warning);
        ...
        public void Press(TabletReference tablet, IDeviceReport report)
        {
            ...
            {
                throw new InvalidOperationException("PenScrollBinding not supported on this device");
            }
        }
